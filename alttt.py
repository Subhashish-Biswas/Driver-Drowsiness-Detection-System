...
thresh = 0.27
modelPath = "C:\\Users\\mehta\\Downloads\\shape_predictor_70_face_landmarks.dat"
sound_path = "C:\\Users\\mehta\\Downloads\\alarm.wav"
    ...
    while(1):
        try:
            ...
            if drowsy:
                ...
                if not ALARM_ON:
                    ALARM_ON = True
                    thread = Thread(target=soundAlert, args=(sound_path, 10,))
